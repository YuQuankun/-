...
public class AppointDao {
    ...
    private final static String NAMESPACE = "com.library.dao.AppointDao.";
    ...
    public int appointBookOne(final long book_id, final long reader_id) {
        Map<String, Object> map = new HashMap<>();
        map.put("book_id", book_id);
        map.put("reader_id", reader_id);
        return sqlSessionTemplate.insert(NAMESPACE + "appointBookOne", map);
    }

    public int appointBookTwo(final long book_id) {
        return sqlSessionTemplate.update(NAMESPACE + "appointBookTwo", book_id);
    }
...
//    }
    ...
    public int insertAppoint(final Appoint appoint){
        return sqlSessionTemplate.insert(NAMESPACE+"insertAppoint",appoint);
    }
}
