...
<div class="panel panel-default" id="insertRegister">
    ...
    <form action="registerAdmin.html" method="post" id="registerAdmin">
        <div class="panel-body">
          <div class="form-group">
            <label for="adminId">账号</label>
            <input type="text" class="form-control" name="adminId" id="adminId" placeholder="请输入账号">
          </div>
          <div class="form-group">
        ...
        <script>
            $("#registerAdmin").submit(function () {
                if($("id").val()==''||$("password").val()==''||$("username").val()==''){
                    alert("账号密码及用户名均不能为空！");
                    return false;
                }
            })
